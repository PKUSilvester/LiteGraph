...
import org.apache.tinkerpop.gremlin.tinkergraph.structure.LiteGraph;
import org.apache.tinkerpop.gremlin.tinkergraph.structure.RedisHelper;
import org.apache.tinkerpop.gremlin.util.iterator.IteratorUtils;

import java.util.*;
import java.util.stream.Collectors;

import static org.apache.tinkerpop.gremlin.tinkergraph.Util.Utility.debugInfoSwitch;
import static org.apache.tinkerpop.gremlin.tinkergraph.Util.Utility.programLamp;

/**
 * @author Marko A. Rodriguez (http://markorodriguez.com)
 * @author Pieter Martin
 */
public final class LiteGraphStep<S, E extends Element> extends GraphStep<S, E> implements HasContainerHolder {
    ...
    private Iterator<? extends Edge> edges() {
        ...
        if (this.ids != null && this.ids.length > 0)
            ...
            return null == indexedContainer ?
                    ...
                    RedisHelper.queryEdgeIndex(graph, indexedContainer.getKey(), indexedContainer.getPredicate().getValue()).stream()
