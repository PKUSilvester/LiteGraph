 ...
 */
public class LiteVertexProperty<V> extends LiteElement implements VertexProperty<V> {

    protected Map<String, Property> properties;
    private final LiteVertex vertex;
     ...
     */
    public LiteVertexProperty(final Object id, final LiteVertex vertex, final String key, final V value, final Object... propertyKeyValues) {
        super(id, key);
        this.vertex = vertex;
        this.key = key;
        this.value = value;
    ...
    public <U> Property<U> property(final String key, final U value) {
        ...
        final Property<U> property = new LiteProperty<U>(this, key, value);
